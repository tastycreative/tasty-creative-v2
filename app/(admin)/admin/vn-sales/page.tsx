    ...
    <div className="min-h-screen p-6 space-y-6 bg-gradient-to-br from-gray-50 via-white to-pink-50">
      ...
      <div className="grid gap-6">
        ...
        <Card className="border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-pink-300 group bg-white relative">
          ...
          <CardHeader>
            <CardTitle className="text-gray-900">Submit Voice Note Sale</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* API Profile Selection */}
              <div>
                <Label htmlFor="apiProfile" className="text-gray-700">Select API Profile</Label>
              ...
              {/* Voice Selection */}
              <div>
                <Label htmlFor="voice-selection" className="text-gray-700">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <Label htmlFor="voiceNote" className="text-gray-700">Select Voice Note</Label>
                  <Button
                    type="button"
                    variant="outline"
                    size="sm"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-sm font-medium text-gray-500">VN Sales Today</h3>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-sm font-medium text-gray-600">Total Voice Generated</h3>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-sm font-medium text-gray-600">Average VN Price</h3>
            ...
            <p className="text-sm text-gray-600">Per voice note</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-xl font-semibold text-gray-900">Sales by Model</h2>
          </div>
          <div className="p-6">
                ...
                vnStats.salesByModel.map((model: any, index: number) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{model.sales} VN sales</p>
                    </div>
                    <div className="text-right">
                      <p className="font-semibold text-green-600">${model.revenue.toFixed(2)}</p>
                      <p className="text-sm text-gray-600">{model.loyaltyPoints} loyalty pts</p>
                    </div>
                  </div>
                ))
              ) : (
