...
import DatabaseErrorFallback from "@/components/admin/DatabaseErrorFallback";
  ...
  try {
    ...
    const userGrowthPercentage =
      totalUsersLastMonth > 0
        ? ((totalUsersThisMonth - totalUsersLastMonth) / totalUsersLastMonth) *
          100
        : 0;
    ...
    const vnSalesData = {
      ...
      loyaltyPointsEarned:
        vnSalesStats?.salesByModel?.reduce(
          (total: number, model: any) => total + model.loyaltyPoints,
          0
        ) || 0,
