  ...
  return (
    <div className="w-full h-full flex flex-col min-h-screen">
        ...
        <div className="block sm:hidden px-4">
          ...
          <div className="mb-4">
            <button
              ...
              className="w-full flex items-center justify-between p-4 rounded-2xl bg-white/10 dark:bg-gray-800/30 backdrop-blur-md border border-white/20 dark:border-gray-700/30"
            >
          ...
          {isMobileMenuOpen && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -10 }}
              className="mb-4 p-4 rounded-2xl bg-white/10 dark:bg-gray-800/30 backdrop-blur-md border border-white/20 dark:border-gray-700/30"
            >
              {/* Generation Tools */}
              <div className="mb-4">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-3 overflow-x-auto scrollbar-hide">
                <div className="flex gap-3 p-2 rounded-2xl bg-white/10 dark:bg-gray-800/30 backdrop-blur-md border border-white/20 dark:border-gray-700/30 min-w-max">
                  {generationTabs.map((tab) => (
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <div className="flex gap-4 p-2 rounded-2xl bg-white/10 dark:bg-gray-800/30 backdrop-blur-md border border-white/20 dark:border-gray-700/30">
                  {generationTabs.map((tab) => (
      ...
      <div className="flex-1 relative overflow-hidden px-4 sm:px-6 lg:px-0">
        {/* Content Container */}
        <div className="h-full rounded-xl sm:rounded-2xl bg-white/5 dark:bg-gray-800/20 backdrop-blur-sm border border-white/10 dark:border-gray-700/20 p-4 sm:p-6 lg:p-8">
          {children}
        </div>
      </div>
    </div>
