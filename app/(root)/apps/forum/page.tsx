...
// Mock data for general forum posts
const mockGeneralPosts: ForumPost[] = [
  {
    id: "g1",
    title: "Welcome to the Community Forum!",
    content:
      "This is a place for all users to discuss anything related to AI, models, tips, and general conversation. Feel free to share your experiences!",
    author: "CommunityMod",
    avatar: "CM",
    upvotes: 89,
    downvotes: 2,
    comments: [
      {
        id: "gc1",
        content:
          "Thanks for creating this space! Looking forward to great discussions.",
        author: "AILover",
        avatar: "AL",
        upvotes: 12,
        downvotes: 0,
  ...
  {
    id: "g2",
    title: "General AI Discussion - What's your favorite use case?",
    content:
      "I'm curious about how everyone is using AI in their daily lives. Whether it's for creative writing, coding, or just chatting - share your stories!",
    author: "TechCurious",
    avatar: "TC",
    upvotes: 156,
    downvotes: 8,
    comments: [
      {
        id: "gc2",
        content:
          "I use AI for brainstorming creative projects. It's amazing how it can help break through creative blocks!",
      ...
      },
      {
        id: "gc3",
        content:
          "Coding assistance is my main use case. AI has really improved my productivity.",
        author: "DevLife",
        avatar: "DL",
        upvotes: 18,
        downvotes: 0,
  ...
  {
    id: "g3",
    title: "Tips for better prompting across all models",
    content:
      "I've been experimenting with different prompting techniques and wanted to share some universal tips that work well across different models...",
  ...
  },
  {
    ...
    content:
      "Would love to see a proper dark mode implementation for the mobile interface. Current one is a bit inconsistent.",
    author: "MobileUser",
    avatar: "MU",
    upvotes: 67,
    downvotes: 5,
    comments: [
      {
        id: "gc4",
        content:
          "Agreed! The mobile experience could definitely use some improvements.",
        author: "UXFan",
        avatar: "UF",
        upvotes: 8,
        downvotes: 0,
...
const categories = [
  ...
  { name: "Success Story", color: "emerald" },
];
...
export default function ForumPage() {
  ...
  >({});
  const [posts, setPosts] = useState(mockGeneralPosts);
  ...
  // Set static models list
  useEffect(() => {
    // Static model list using the actual model names from the app
  ...
  // Switch between general posts and model-specific posts
  useEffect(() => {
    if (selectedModel === "General") {
      setPosts(mockGeneralPosts);
    } else {
      // In a real app, you'd fetch model-specific posts here
      // For now, we'll show empty or mock model posts
      setPosts([]);
    }
  }, [selectedModel]);
                  ...
                  {selectedPost.comments.map((comment) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button className="text-xs text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors ml-2">
                          Reply
                        </button>
                      </div>
                    </div>
