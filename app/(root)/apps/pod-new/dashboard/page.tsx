...
const DashboardWithTeamSidebarNew = dynamic(() => import("@/components/DashboardWithTeamSidebarNew").then(mod => ({ default: mod.DashboardWithTeamSidebarNew })), {
  loading: () => <div className="p-6"><Skeleton className="h-64 w-full" /></div>,
  ssr: false,
})

export default function NewPodDashboardPage() {
  ...
  useEffect(() => {
    if (
      ...
      console.log('🎯 New Pod Dashboard triggering fetchPricingPreview with:', {
