...
export async function PATCH(
  ...
  try {
    ...
    const { caption, pricing, basePriceDescription, gifUrl, notes, isFinal, contentTags, componentData } = body;
    ...
    if (componentData !== undefined) updateData.componentData = componentData;
