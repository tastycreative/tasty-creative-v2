...
const N8N_GALLERY_SHEET_WEBHOOK_URL =
  process.env.N8N_GALLERY_SHEET_WEBHOOK_URL ||
  "https://n8n.tastycreative.xyz/webhook/gallery-data-otm-otp-gen";
  ...
  try {
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { error: "Webhook failed", details: errorText },
