...
const statusConfig = {
  NOT_STARTED: {
    label: "Not Started",
    icon: Clock,
    color: "bg-slate-800/50 text-gray-300 border-white/10",
    headerColor: "bg-slate-800/70 border-white/10",
...
const priorityConfig = {
  LOW: { label: "Low", color: "bg-slate-700/50 text-gray-300" },
    ...
    <div className="animate-pulse">
      ...
      <div className="space-y-1">
        <div className="flex items-center">
          <div className="h-3 w-3 bg-gray-700 rounded mr-1"></div>
...
const ColumnHeaderSkeleton = () => (
  <div className="p-4 bg-slate-800/70 animate-pulse">
    <div className="flex items-center justify-between">
      <div className="flex items-center">
        <div className="h-5 w-5 bg-gray-600 rounded mr-2"></div>
        <div className="h-4 bg-gray-600 rounded w-20"></div>
        <div className="ml-2 h-5 w-8 bg-gray-700 rounded-full"></div>
      </div>
...
export default function Board({
  ...
  const getColumnConfig = useMemo(() => {
    const columnConfig = () => {
      if (columns.length === 0) {
        console.log(
          "Using default statusConfig, columns.length:",
          columns.length
        );
      ...
      console.log(
        ...
        columns.length,
        columns.map((c) => ({ label: c.label, position: c.position }))
      );
      return columns
  ...
  if (showMinimumSkeleton || (isLoading && tasks.length === 0)) {
    return (
      <div className="space-y-6">
        ...
        <div className="bg-slate-900/70 backdrop-blur-md border border-white/10 rounded-xl shadow-lg p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
              ...
              <div className="relative w-full sm:w-auto">
                <div className="flex items-center space-x-2 sm:space-x-3 bg-slate-800/50 backdrop-blur-sm border border-white/20 rounded-lg px-3 sm:px-4 py-2 shadow-sm hover:shadow-md transition-all">
                  ...
                  <select
                    ...
                    className="bg-transparent border-none outline-none text-sm font-medium text-white cursor-pointer hover:text-blue-400 transition-colors appearance-none pr-6 min-w-0 flex-1"
                    style={{
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/70 backdrop-blur-md border border-white/10 rounded-xl shadow-lg p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <div className="flex items-center space-x-2 text-sm text-gray-400 bg-slate-800/50 px-3 py-2 rounded-lg">
              <svg
                className="w-4 h-4"
                fill="none"
                stroke="currentColor"
      ...
      <div className="bg-slate-900/70 backdrop-blur-sm border border-white/10 rounded-lg shadow-lg p-4 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 flex-1">
            ...
            <div className="relative flex-1 sm:max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-white/20 rounded-md bg-slate-800/50 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm"
              />
              {searchTerm && (
                <button
      ...
      <div className="bg-slate-900/70 backdrop-blur-sm border border-white/10 rounded-lg shadow-lg overflow-hidden">
                ...
                {showNewTaskForm === status && (
                  <div className="mt-4 p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg">
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setNewTaskData({ description: e.target.value })
                      }
                    ...
                    <UserDropdown
                      ...
                      onChange={(email) =>
                        setNewTaskData({ assignedTo: email })
                      }
                    ...
                    <div className="flex items-center justify-between mt-3">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button
                          onClick={() =>
                            handleCreateTask(status as Task["status"])
                          }
                ...
                <div className="space-y-3">
                  ...
                  {statusTasks.length === 0 && !isLoading && (
                    <div className="text-center py-8">
                      <div
                        className={`w-16 h-16 mx-auto mb-4 rounded-full ${config.color} flex items-center justify-center opacity-50`}
                      >
                        <config.icon className="h-8 w-8" />
                      </div>
            ...
            <div className="relative px-4 sm:px-8 py-4 sm:py-6 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-white/50 to-gray-50/50 dark:from-gray-800/50 dark:to-gray-900/50">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
                  <div
                    className={`w-3 h-3 rounded-full ${statusConfig[newTaskStatus].color.split(" ")[0]} flex-shrink-0`}
                  ></div>
                  <div className="min-w-0 flex-1">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <UserDropdown
                    value={newTaskData.assignedTo}
                    onChange={(email) =>
                      setNewTaskData((prev) => ({ ...prev, assignedTo: email }))
                    }
                    placeholder="Search and select user..."
                    className=""
                  />
