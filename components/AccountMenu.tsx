  ...
  return (
    <div className="relative mb-6">
      ...
      >
        ...
        <ChevronDown className="w-4 h-4 text-slate-500 dark:text-slate-400 transition-transform duration-200 peer-checked:rotate-180" />
      </label>
