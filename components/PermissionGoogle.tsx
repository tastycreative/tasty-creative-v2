...
const PermissionGoogle: React.FC<PermissionGoogleProps> = ({
  ...
  if (isLoading || sessionStatus === "loading") {
    return (
      <div className="flex items-center justify-center p-4 sm:p-6 lg:p-8 rounded-xl bg-transparent dark:bg-gray-800/40 backdrop-blur-sm border border-white/10 dark:border-pink-500/30 shadow-lg w-full">
