    ...
    >
      {modelDataLoading ? (
        <div className="flex items-center justify-center h-40">
          <div className="flex flex-col items-center space-y-4">
            <div className="relative">
              <div className="animate-spin rounded-full h-10 w-10 border-2 border-pink-500/30 border-t-pink-500"></div>
        ...
        <>
          {/* Update notification */}
          {timestamp && (
            <div className="mb-6 p-3 rounded-lg bg-gradient-to-r from-emerald-50/50 to-pink-50/50 border border-emerald-200/30">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-6">
            <div className="flex-1">
              <div className="flex flex-wrap items-center gap-3 mb-2">
                ...
                <div className="flex items-center space-x-1 px-3 py-1 bg-gradient-to-r from-pink-100 to-rose-100 rounded-full border border-pink-200/50">
              ...
              {dashboard && (
                <Link
                  ...
                  className="inline-flex items-center space-x-1 text-sm text-pink-600 hover:text-pink-700 duration-200 group"
                >
            ...
            <div className="lg:w-80">
              ...
              <div className="relative h-3 bg-gray-200/50 rounded-full overflow-hidden backdrop-blur-sm">
                <div
                  className="absolute inset-y-0 left-0 bg-gradient-to-r from-pink-500 via-rose-500 to-pink-600 rounded-full transition-all duration-700 ease-out shadow-sm"
                ...
                {prepItems.map((item, index) => (
                  <div
                    ...
                    className={cn(
                      ...
                      item.status === "Done"
                        ? "bg-gradient-to-br from-emerald-50/70 to-green-50/70 border border-emerald-200/50"
                        : "bg-gradient-to-br from-red-50/70 to-orange-50/70 border border-red-200/50"
                    )}
                  >
