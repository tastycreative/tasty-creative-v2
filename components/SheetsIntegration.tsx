...
import { Loader2, FileSpreadsheet, Copy, CheckCircle, AlertCircle, ExternalLink } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 bg-blue-50 dark:bg-blue-900/30 p-3 rounded-lg border border-blue-200 dark:border-blue-700">
              <strong>💡 Tip:</strong> Enter the Google Sheets URL to sync all Schedule #1 sheets with real-time updates!
            </p>
          </div>
