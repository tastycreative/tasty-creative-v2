...
>("all");
  ...
  const getStatusBgColor = (status: string) => {
    switch (status) {
      case "healthy":
        return "bg-pink-50 dark:bg-pink-900/20 border-pink-200 dark:border-pink-500/30";
      case "warning":
    ...
    <div className="min-h-screen bg-pink-50/30 dark:bg-gray-950 p-6 space-y-6">
      ...
      {successMessage && (
        <div className="fixed top-4 right-4 z-50 max-w-sm w-full animate-in slide-in-from-right-full duration-300">
          <div className="bg-pink-50 dark:bg-pink-900/30 border border-pink-200 dark:border-pink-500/30 rounded-lg p-4 shadow-lg backdrop-blur-sm">
            <div className="flex items-center">
              ...
              <button
                ...
                className="ml-3 flex-shrink-0 text-pink-400 hover:text-pink-600 dark:hover:text-pink-300 transition-colors"
              >
                <X className="h-4 w-4" />
              </button>
            </div>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-white via-pink-50/30 to-purple-50/30 dark:from-gray-900 dark:via-purple-900/20 dark:to-pink-900/20 backdrop-blur-sm border border-pink-200/50 dark:border-pink-500/30 rounded-2xl p-6 sm:p-8 shadow-lg shadow-pink-500/10">
        {/* Background pattern */}
        <div className="absolute inset-0 bg-gradient-to-br from-pink-500/5 via-purple-500/10 to-blue-500/5 opacity-60" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(236,72,153,0.1),transparent_50%)]" />
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
            <div className="flex items-center space-x-4">
              <div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-pink-500/25">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 font-medium mt-1">Manage teams, users, and system settings</p>
              </div>
            </div>
            <div className="flex items-center gap-3 self-start sm:self-auto">
              <span className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-pink-100 to-purple-100 dark:from-pink-900/30 dark:to-purple-900/30 text-pink-700 dark:text-pink-300 rounded-full text-sm font-bold border border-pink-200/50 dark:border-pink-500/30 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto bg-white/50 dark:bg-gray-800/50 p-2 rounded-xl backdrop-blur-sm border border-pink-200/30 dark:border-pink-500/20 shadow-sm">
            <button
              onClick={() => setActiveView("overview")}
              className={`px-6 py-3 rounded-xl text-sm font-bold transition-all duration-200 w-full sm:w-auto transform hover:scale-[1.02] ${
                activeView === "overview"
                  ? "bg-gradient-to-r from-pink-500 to-purple-500 text-white shadow-lg shadow-pink-500/25 border border-pink-400/20"
                  : "bg-white/80 dark:bg-gray-700/80 text-gray-700 dark:text-gray-300 hover:bg-pink-50 dark:hover:bg-pink-900/20 hover:text-pink-600 dark:hover:text-pink-400 border border-gray-200/50 dark:border-gray-600/50 hover:border-pink-300/50 dark:hover:border-pink-500/30"
              }`}
            >
              Overview
            </button>
                      ...
                      <div className="flex items-start gap-4 mb-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 dark:text-gray-300 mt-1 text-lg font-medium">
                            Manage your teams, members, and collaborative workflows
                          </p>
                          <div className="flex items-center gap-4 mt-2 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span>•</span>
                            <span className="px-3 py-1 bg-gradient-to-r from-pink-100 to-purple-100 dark:from-pink-900/30 dark:to-purple-900/30 text-pink-700 dark:text-pink-300 rounded-full text-sm font-medium border border-pink-200/50 dark:border-pink-500/30">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                      <div className="relative flex-1 lg:flex-initial">
                        ...
                        <input
                          ...
                          className="pl-10 pr-4 py-3 w-full lg:w-64 border border-pink-200/50 dark:border-pink-500/30 rounded-xl bg-white/80 dark:bg-gray-800/80 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-pink-500 focus:border-transparent backdrop-blur-sm transition-all duration-200 hover:border-pink-300 dark:hover:border-pink-400"
                        />
                      </div>

                      <button
                        onClick={() => setShowAddTeamForm(true)}
                        className="flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white rounded-xl transition-all duration-200 w-full sm:w-auto whitespace-nowrap shadow-lg shadow-pink-500/25 hover:shadow-pink-500/40 border border-pink-400/20"
                      >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {filteredTeams.map((team) => {
                  ...
                  return (
                    <div
                      key={team.id}
                      className="group relative overflow-hidden bg-gradient-to-br from-white via-pink-50/30 to-purple-50/30 dark:from-gray-900 dark:via-gray-800/50 dark:to-purple-900/30 rounded-2xl border border-pink-200/50 dark:border-pink-500/20 p-6 hover:shadow-2xl hover:shadow-pink-500/10 transition-all duration-300 hover:border-pink-300/70 dark:hover:border-pink-400/40 backdrop-blur-sm"
                    >
                      {/* Background glow effect */}
                      <div className="absolute inset-0 bg-gradient-to-br from-pink-500/5 via-purple-500/10 to-blue-500/5 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                      ...
                      <div className="relative z-10">
                          ...
                          <div className="flex-1">
                            {editingTeamName === team.id ? (
                              <div className="flex items-center space-x-2 mb-1">
                                <input
                                  ...
                                  className="text-lg font-semibold bg-transparent border-b-2 border-purple-500 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-pink-600 flex-1"
                                ...
                                <button
                                  ...
                                  className="p-1 text-pink-600 hover:bg-pink-100 dark:hover:bg-pink-900/30 rounded disabled:opacity-50"
                                >
                              ...
                              <div className="flex items-center space-x-2 mb-2">
                                <h4 className="text-xl font-bold bg-gradient-to-r from-gray-900 via-pink-600 to-purple-600 dark:from-gray-100 dark:via-pink-400 dark:to-purple-400 bg-clip-text text-transparent">
                                  {team.name}
                                </h4>
                                <button
                                  onClick={() => {
                                  ...
                                  className="p-1.5 text-pink-400 hover:text-pink-600 dark:hover:text-pink-300 hover:bg-pink-50 dark:hover:bg-pink-900/20 rounded-lg transition-all duration-200 border border-transparent hover:border-pink-200 dark:hover:border-pink-500/30"
                                  title="Edit team name"
                                >
                                  <Edit className="h-4 w-4" />
                                </button>
                                {teamNameSuccess === team.id && (
                                  <span className="flex items-center gap-1 text-pink-600 dark:text-pink-400 text-sm font-medium bg-emerald-50 dark:bg-emerald-900/20 px-2 py-1 rounded-full border border-emerald-200 dark:border-emerald-500/30">
                            ...
                            {editingTeamPrefix === team.id ? (
                              ...
                              <div className="flex items-center space-x-2 mb-3">
                                ...
                                {team.projectPrefix ? (
                                  <>
                                    <span className="px-3 py-1.5 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 text-purple-700 dark:text-purple-400 text-sm font-mono rounded-lg border border-purple-200/50 dark:border-purple-500/30 shadow-sm">
                                      {team.projectPrefix}
                                    </span>
                                    <button
                                      onClick={() => {
                                      ...
                                      className="p-1.5 text-purple-400 hover:text-purple-600 dark:hover:text-purple-300 hover:bg-pink-50 dark:hover:bg-pink-900/20 rounded-lg transition-all duration-200 border border-transparent hover:border-pink-200 dark:hover:border-pink-500/30"
                                  ...
                                  <>
                                    <span className="px-3 py-1.5 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 text-gray-500 dark:text-gray-400 text-sm rounded-lg border border-gray-200 dark:border-gray-600 shadow-sm">
                                      None
                                    </span>
                                    <button
                                      onClick={() => {
                                      ...
                                      className="p-1.5 text-purple-500 hover:text-purple-700 dark:hover:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-lg transition-all duration-200 border border-transparent hover:border-purple-200 dark:hover:border-purple-500/30"
                              ...
                              {editingCreators === team.id ? (
                                <div className="space-y-3">
                                  <div className="flex items-center space-x-2">
                                    <div className="w-4 h-4 bg-pink-600 rounded-sm flex items-center justify-center">
                                  ...
                                  <div className="flex items-center space-x-2">
                                    <button
                                      ...
                                      className="p-2 text-pink-600 hover:bg-pink-100 dark:hover:bg-pink-900/30 rounded-lg disabled:opacity-50 transition-colors"
                                    >
                                    ...
                                    {team.creators && team.creators.length > 0 ? (
                                      <div className="flex flex-wrap gap-1">
                                        {team.creators.map((creator, index) => (
                                          <span
                                            key={index}
                                            className="inline-flex items-center px-2 py-1 bg-purple-100 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-500/30 rounded-full text-xs font-medium text-pink-700 dark:text-purple-300"
                                          >
                                            {creator}
                                          </span>
                                        ))}
                        ...
                        {/* Enhanced Action Buttons - Gallery Style */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4 mb-6">
                          <button
                            onClick={() => setShowMembersModal(team.id)}
                            className="group bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 dark:from-blue-900/20 dark:via-indigo-900/30 dark:to-blue-800/20 rounded-xl p-4 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 text-left cursor-pointer border border-blue-200/50 dark:border-blue-500/30 hover:border-blue-300 dark:hover:border-blue-400 transform hover:scale-[1.02]"
                          >
                          ...
                          <button
                            ...
                            className="group bg-gradient-to-br from-pink-50 via-purple-50 to-pink-100 dark:from-pink-900/20 dark:via-purple-900/30 dark:to-pink-800/20 rounded-xl p-4 hover:shadow-lg hover:shadow-pink-500/20 transition-all duration-300 text-left cursor-pointer border border-pink-200/50 dark:border-pink-500/30 hover:border-pink-300 dark:hover:border-pink-400 transform hover:scale-[1.02]"
                          >
                            <div className="flex items-center space-x-3">
                              <div className="w-10 h-10 bg-gradient-to-br from-pink-500 to-purple-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                                <ClipboardList className="h-5 w-5 text-white" />
                              </div>
                              <div>
                                <span className="text-lg font-bold text-pink-700 dark:text-pink-300 block">
                                  {stats.totalTasks}
                                </span>
                          ...
                          <button
                            ...
                            className="group bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100 dark:from-purple-900/20 dark:via-pink-900/30 dark:to-purple-800/20 rounded-xl p-4 hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300 text-left cursor-pointer border border-purple-200/50 dark:border-purple-500/30 hover:border-purple-300 dark:hover:border-purple-400 transform hover:scale-[1.02] sm:col-span-2 lg:col-span-1 xl:col-span-2 2xl:col-span-1"
                          >
                            <div className="flex items-center space-x-3">
                        ...
                        {stats.totalTasks > 0 && (
                          <div className="mb-6">
                            <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-700/50 rounded-xl p-4 border border-gray-200/50 dark:border-gray-600/30">
                              ...
                              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 shadow-inner">
                                <div
                                  className="bg-gradient-to-r from-pink-500 via-purple-500 to-pink-600 h-3 rounded-full transition-all duration-500 shadow-sm"
                                  style={{
              ...
              {filteredTeams.length === 0 && (
                <div className="col-span-full text-center py-12">
                  ...
                  {!searchQuery && (
                    <button
                      onClick={() => setShowAddTeamForm(true)}
                      className="inline-flex items-center space-x-2 px-4 py-2 bg-pink-600 hover:bg-pink-700 text-white rounded-lg transition-colors"
                    >
                      <Plus className="h-4 w-4" />
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div className="flex items-center space-x-3 flex-shrink-0">
                          ...
                          <button
                            ...
                            className="flex items-center space-x-2 px-3 py-2 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white rounded-lg transition-colors text-sm whitespace-nowrap shadow-lg shadow-pink-500/25"
                          >
                            <Plus className="h-4 w-4" />
                              ...
                              <div className="flex items-center justify-between sm:justify-end space-x-3">
                                {editingMember === `${team.id}-${member.id}` ? (
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <button
                                      ...
                                      className="p-1 text-pink-600 hover:text-pink-800 flex-shrink-0"
                                    >
                                ...
                                <div className="flex items-center space-x-1 sm:space-x-2">
                                  ...
                                  <button
                                    ...
                                    className="p-2 text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-gray-200 dark:hover:bg-gray-600 rounded"
                                    title="Edit role"
                                  >
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mt-3 sm:mt-0">
                        <div className="flex flex-row gap-2 sm:gap-3 flex-1">
                          ...
                          <button
                            ...
                            className="flex items-center justify-center space-x-2 px-3 py-2 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white rounded-lg transition-colors text-sm flex-1 sm:flex-none shadow-lg shadow-pink-500/25"
                                      ...
                                      {editingTask === task.id ? (
                                        ...
                                        <div className="flex items-center space-x-2 flex-1">
                                          ...
                                          <button
                                            ...
                                            className="p-1 text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 flex-shrink-0"
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 disabled:opacity-50 text-white rounded-lg transition-colors shadow-lg shadow-pink-500/25"
              >
                  ...
                  return (
                    <div className="text-center py-12">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white rounded-lg transition-colors shadow-lg shadow-pink-500/25"
                      >
                        Clear Filters
                      </button>
                    </div>
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between mb-6">
                        ...
                        <button
                          ...
                          className="group flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-pink-600 hover:to-pink-600 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
                        >
                  ...
                  return availableMembers.map((member) => (
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        ...
                        <div className="text-xs text-purple-600 dark:text-purple-400 font-semibold mt-1 px-2 py-1 bg-blue-50 dark:bg-blue-900/30 rounded-full inline-block">
                          {member.role}
                        </div>
                      </div>
                      {assigningMember ? (
...
const UserRoleCard: React.FC<UserRoleCardProps> = ({ user, onRoleUpdate }) => {
  ...
  const getRoleColor = (role: string) => {
    switch (role) {
      ...
      case "USER":
        return "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300 border-pink-300 dark:border-pink-500/30";
      case "ADMIN":
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className={`flex items-center justify-center space-x-2 px-3 py-2 rounded-lg transition-colors text-sm font-medium ${
                user.role === "USER"
                  ? "bg-pink-100 dark:bg-pink-900/30 text-pink-800 dark:text-pink-300 border border-pink-300 dark:border-pink-500/30"
                  : "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-pink-100 dark:hover:bg-pink-900/30 hover:text-green-700 dark:hover:text-green-300"
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center justify-center space-x-2 px-3 py-2 rounded-lg transition-colors text-sm font-medium ${
                user.role === "POD"
                  ...
                  : "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-purple-100 dark:hover:bg-purple-900/30 hover:text-pink-700 dark:hover:text-purple-300"
              }`}
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-6 space-y-6">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 flex items-center">
              <span className="w-8 h-8 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center text-pink-600 dark:text-purple-400 text-sm font-bold mr-3">
                1
              </span>
              Basic Information
            </h4>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  {!isLoadingCreators && (
                    <button
                      ...
                      className="text-xs text-pink-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300"
                    ...
                    return (
                      ...
                      >
                        <input
                          ...
                          className="h-5 w-5 text-pink-600 border-gray-300 dark:border-gray-600 rounded focus:ring-purple-500 focus:ring-2"
                        />
                ...
                <div className="border border-gray-300 dark:border-gray-600 rounded-lg p-6 bg-gray-50 dark:bg-gray-800 text-center">
                  ...
                  {availableCreators.length === 0 && (
                    <button
                      type="button"
                      onClick={fetchAvailableCreators}
                      className="mt-2 px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-pink-700 dark:text-purple-300 rounded text-sm hover:bg-purple-200 dark:hover:bg-purple-900/50"
                    >
                      Retry
                    </button>
                  )}
                    ...
                    {selectedCreators.map((creator) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="ml-1 text-pink-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-200"
                        >
                          <X className="h-3 w-3" />
                        </button>
                      </span>
          ...
          <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-6 space-y-6">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 flex items-center">
              <span className="w-8 h-8 bg-pink-100 dark:bg-pink-900/30 rounded-full flex items-center justify-center text-purple-600 dark:text-purple-400 text-sm font-bold mr-3">
                3
              </span>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedMembers.map((member) => {
                      ...
                      return (
                        <span
                          key={member.userId}
                          className="inline-flex items-center px-3 py-1 bg-pink-100 dark:bg-pink-900/30 text-blue-800 dark:text-blue-300 text-sm rounded-full"
                        >
                          {user?.email ? `${user.email} - ${member.role}` : `${user?.name || "Unknown"} - ${member.role}`}
                          <button
                            type="button"
                            onClick={() => handleMemberRemove(member.userId)}
                            className="ml-2 text-purple-600 dark:text-purple-400 hover:text-blue-800 dark:hover:text-blue-200"
                          >
                            <X className="h-4 w-4" />
                          </button>
                        </span>
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <button
              ...
              className="flex-1 px-4 py-2 bg-pink-600 hover:bg-pink-700 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
            >
              {isSubmitting ? (
                <>
...
const AddMemberForm = ({
  ...
  const getRoleColor = (role: string) => {
    switch (role) {
      ...
      case "Member":
      default:
        return "bg-pink-100 dark:bg-pink-900/30 text-pink-800 dark:text-pink-300 border border-pink-300 dark:border-pink-500/30";
    }
  };
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="flex items-center space-x-1 px-2 py-1 text-xs text-gray-600 dark:text-gray-400 hover:text-pink-600 dark:hover:text-pink-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  return (
                    ...
                    >
                      <input
                        ...
                        className="mr-3 h-4 w-4 text-pink-600 border-gray-300 dark:border-gray-600 rounded focus:ring-purple-500 focus:ring-2"
                      />
