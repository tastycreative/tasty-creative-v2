...
export default function GalleryNew({ teamName, teamId }: GalleryProps) {
  ...
  const filteredFolders = folders.filter(folder => {
    ...
    const isVideo = folder.mimeType?.startsWith('video/') || folder.fileType === 'VIDEO';
    return fileTypeFilter === 'IMAGE' ? isImage : isVideo;
  });
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md mb-4">
                {searchQuery ? (
                  ...
                  `No ${fileTypeFilter.toLowerCase()} folders found`
                ) : selectedClientModel ? (
