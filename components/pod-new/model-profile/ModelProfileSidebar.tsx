        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex gap-3 flex-1 justify-end">
            <Button
              variant="outline"
              size="sm"
              className="bg-gradient-to-r from-white/60 to-white/40 dark:from-gray-800/60 dark:to-gray-800/40 backdrop-blur-sm border-gray-200/60 dark:border-gray-700/50 hover:bg-gradient-to-r hover:from-white/80 hover:to-white/60 dark:hover:from-gray-700/80 dark:hover:to-gray-700/60 transition-all duration-300 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100"
            >
