          ...
          <div className="flex items-center gap-2 ">
            {activeTab !== "all" && (
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-gray-500 to-black/50 hover:from-gray-400 hover:to-black/40 text-white  rounded-lg font-medium transition-colors flex items-center gap-2"
              >
            ...
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-400 hover:to-pink-400 text-white  rounded-lg font-medium transition-colors flex items-center gap-2"
            >
            ...
            <button
              ...
              className=" px-4 py-2 bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-400 hover:to-amber-400 text-white  rounded-lg font-medium transition-colors flex items-center gap-2"
            >
            ...
            <button
              ...
              className=" px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-400 hover:to-cyan-400 text-white  rounded-lg font-medium transition-colors flex items-center gap-2"
            >
